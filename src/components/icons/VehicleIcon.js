function VehicleIcon (){
  return (
    <svg width="10" height="15" viewBox="0 0 10 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M5 4.5C6.10457 4.5 7 3.60457 7 2.5C7 1.39543 6.10457 0.5 5 0.5C3.89543 0.5 3 1.39543 3 2.5C3 3.60457 3.89543 4.5 5 4.5Z" stroke="#3B3B3B" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
